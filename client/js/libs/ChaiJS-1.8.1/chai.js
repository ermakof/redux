...
module.exports = function (chai, _) {
  ...
  Assertion.addProperty('empty', function () {
    ...
    if (Array.isArray(obj) || 'string' === typeof object) {
      ...
      // #9593 ===================
      //if (!expected) {
      //  var serializedString = ((new XMLSerializer()).serializeToString(obj));
      //  if (serializedString && typeof serializedString === 'string') {
      //    expected = serializedString.length;
      //  }
      //}
      // =================== #9593
    }
...
function formatValue(ctx, value, recurseTimes) {
  ...
  if (value && typeof value.inspect === 'function' &&
      // QuickFilters out the util module, it's inspect function is special
...
require.alias("chai/index.js", "chai/index.js");if (typeof exports == "object") {
  ...
  define(function(){ return require("chai"); });
    ...
    try{
      this["chai"] = require("libs/ChaiJS-1.8.1/chai");
    } catch (e){
